...
use App\Repositories\Respaldo\RespaldoBdRepository;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Inertia\Inertia;

class RespaldoBdService extends BaseService
{
    protected function repositoryClass(): string
    {
        return RespaldoBdRepository::class;
    }
    ...
    public function indexData(Request $request)
    {
        ...
        return Inertia::render('RespaldosBd/Index', [
    ...
    {
        return Inertia::render('RespaldosBd/Form');
    }
    ...
    {
        return Inertia::render('RespaldosBd/Show', [
            'respaldo' => $respaldo,
        ]);
    }
    ...
    public function validateAndCreate(Request $request)
    {
        ...
        if ($request->hasFile('archivo')) {
            $path = $request->file('archivo')->store('respaldos_bd', 'local');
    ...
    {
        return "Respaldo BD {$model->nombre} {$accion}do";
    }
}
