...
class ConfiguracionController extends Controller
{
    ...
    public function store(Request $request, Equipo $equipo)
    {
        ...
        return redirect()->route('equipos.configuraciones.index', $equipo)->with('success', 'Configuración creada correctamente.');
    }
    ...
    public function update(Request $request, Equipo $equipo, Configuracion $configuracion)
    {
        ...
        return redirect()->route('equipos.configuraciones.index', $equipo)->with('success', 'Configuración actualizada correctamente.');
    }

    public function destroy(Equipo $equipo, Configuracion $configuracion)
    {
        $this->configuracionService->delete($configuracion);
        return redirect()->route('equipos.configuraciones.index', $equipo)->with('success', 'Configuración eliminada correctamente.');
    }
