<template>
  <div class="flex flex-col gap-6">
    <div class="flex items-center gap-2">
      ...
      <h1 class="text-2xl font-bold">Detalle de Respaldo de Correos</h1>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <Card>
        ...
        <template #footer>
          <Button v-if="respaldo.archivo" label="Descargar Archivo" icon="pi pi-download" class="w-full" severity="info" @click="router.get(`/respaldos/correos/${respaldo.id}/download`)" />
        </template>
      </Card>
    </div>
  </div>
